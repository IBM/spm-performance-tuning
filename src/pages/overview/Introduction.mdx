...
Learn about the key tuning parameters for a system deployment of Cúram, including formulas to use for some parameters and starter values for others.
...
In the section **Common Tuning Tasks**, all recommendations are applicable to any Cúram deployment irrespective of deployment on traditional infrastructure (VM/bare metal) or Kubernetes.
